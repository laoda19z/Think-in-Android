...
<div id="main">
	...
	<div class="left main-sidebar">	
		<div class="sidebar-inner leftscroll">
			...
			<ul>
				<li class="submenu">
					<a href="OrdersServlet"><i class="fa fa-fw fa-bars"></i><span>ORDERS</span> </a>
                </li>
				<li class="submenu">
					...
					<div class="card mb-3">
						...
						<c:forEach items="${page.list }" var="user">
							<div class="alert alert-info" role="alert">
								用户名称：${user.username }&nbsp&nbsp用户编号：${user.userId }&nbsp&nbsp用户真实名称：${user.realname }&nbsp&nbsp用户性别：${user.sex }&nbsp&nbsp用户邮箱：${user.email }&nbsp&nbsp用户电话号码：${user.phoneNum }
							</div>
							</c:forEach>
							总共有${page.totalPageNum }页，总共有${page.totalCount }个数据，当前是第${page.currentPageNum}页 ；
