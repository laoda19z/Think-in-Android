...
<div id="main">
	...
	<div class="left main-sidebar">	
		<div class="sidebar-inner leftscroll">
			...
			<ul>
				<li class="submenu">
					<a class="OrdersServlet" href="index.jsp"><i class="fa fa-fw fa-bars"></i><span>ORDERS</span> </a>
                </li>
				<li class="submenu">
                    <a href="CakesServlet"><i class="fa fa-fw fa-area-chart"></i><span>CAKES</span> </a>
                </li>
            </ul>
			</div>
		</div>
