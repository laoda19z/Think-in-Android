...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="index.html" class="logo"><img alt="logo" src="assets/images/logo.png" /> <span>乐动云</span></a>
        </div>
	</div>
	<!-- End Navigation -->
	...
	<div class="left main-sidebar">	
		<div class="sidebar-inner leftscroll">
			...
			<ul>
				<li class="submenu">
					<a href="#"><i class="fa fa-fw fa-bars"></i><span>设置</span> </a>
                </li>
				<li class="submenu">
                    <a class="active" href="#"><i class="fa fa-fw fa-area-chart"></i><span>用户</span> </a>
                </li>			
            </ul>
			</div>
		</div>
					...
					<div class="card mb-3">
						...
						<c:forEach items="${page.list }" var="user">
							<div class="alert alert-info" role="alert">
								用户名称：${user.username }&nbsp&nbsp用户编号：${user.userId }&nbsp&nbsp用户真实名称：${user.realname }&nbsp&nbsp
								<br/>用户性别：${user.sex }&nbsp&nbsp用户邮箱：${user.email }&nbsp&nbsp
								<br/>用户电话号码：${user.phoneNum }
								<br/>头像：<img alt="${user.username }" src="${user.headImg }" id="pic">
							</div>
							</c:forEach>
							总共有${page.totalPageNum }页，总共有${page.totalCount }个数据，当前是第${page.currentPageNum}页 &nbsp&nbsp&nbsp
							<a href="${ctx }/UserPageServlet?&page=1">首页</a>
							<a href="${ctx }/UserPageServlet?&page=${page.prePageNum }">上一页</a>
							<a href="${ctx }/UserPageServlet?&page=${page.nextPageNum }">下一页</a>
							<a href="${ctx }/UserPageServlet?&page=${page.totalPageNum }">末页</a>
						</div>	
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
					<div class="card mb-3">
						<div class="card-body">
							...
							<form class="alert alert-success" role="alert" action="${ctx }/AddUserPageServlet">
								用户昵称：<input type="text" name="userName"><br>
								用户密码：<input type="text" name="userPwd"><br>
								<input type="submit" value="确认增加">
							</form>
													
							<form class="alert alert-danger" role="alert" action="${ctx }/DeleteUserPageServlet">
								请根据左侧用户列表输入要删除的用户编号：<br>
