            ...
            public void handleMessage(@NonNull Message msg) {
                switch (msg.what){
                    case 1:
                        ...
                        //设置展示适配器
                        ActivitiesAdapter activitiesAdapter = new ActivitiesAdapter(FamilyActivity.this, activitiesInfo.getActivities());
                        ListView parentChildList = findViewById(R.id.parentChild_list);
                        parentChildList.setAdapter(activitiesAdapter);
                        //设置全局的Header构建器
...
//                    Log.i("查看结果", "读写通过！！！");
                    ...
                    JSONArray jArray = jCakes.getJSONArray("activities");
